...
class RoleServiceTest {
    ...
    void testGetRoleByCode_InvalidRole() {
        // Given
        when(messageService.getMessage(anyString(), anyString())).thenReturn("Invalid role");
    ...
    void testGetRoleByCode_NotFound() {
        ...
        when(messageService.getMessage(anyString(), anyString())).thenReturn("Role not found");
    ...
    void testInitializeDefaultRoles_Success() {
        // Given - stub all 6 roles as not existing using doReturn for lenient stubbing
        ...
        // Then - verify save was called 6 times (once for each role enum value)
