...
class UserServiceTest {
    ...
    void testGetAllUsers_WithSearch() {
        ...
        // When
        Page<UserDTO> result = userService.getAllUsers(0, 10, "test");
    ...
    void testDisableUser_Success() {
        ...
        // When
        UserDTO result = userService.disableUser(1L, false);
    ...
    void testLockUser_Lock() {
        ...
        // When
        UserDTO result = userService.lockUser(1L, true);
    ...
    void testAddRoleToUser_Success() {
        ...
        // When
        UserDTO result = userService.addRoleToUser(1L, "SHOP_OWNER");
    ...
    void testRemoveRoleFromUser_Success() {
        ...
        // When
        UserDTO result = userService.removeRoleFromUser(1L, "SHOP_OWNER");
    ...
    void testChangePasswordOnFirstLogin_Success() {
        ...
        // When
        UserDTO result = userService.changePasswordOnFirstLogin(passwordRequest);
    ...
    void testChangePassword_Success() {
        ...
        // When
        UserDTO result = userService.changePassword(passwordRequest);
    ...
    void testGetAllUsers_Empty() {
        ...
        // When
        Page<UserDTO> result = userService.getAllUsers(0, 10, "nonexistent");
    ...
    void testUpdateUser_WithEmail() {
        ...
        // When
        UserDTO result = userService.updateUser(1L, updateWithEmail);
    ...
    void testUpdateUser_WithPassword() {
        ...
        // When
        UserDTO result = userService.updateUser(1L, updateWithPassword);
    ...
    void testAddRoleToUser_UserHasNoRoles() {
        ...
        // When
        UserDTO result = userService.addRoleToUser(1L, "MANAGER");
    ...
    void testRemoveRoleFromUser_UserHasMultipleRoles() {
        ...
        // When
        UserDTO result = userService.removeRoleFromUser(1L, "MANAGER");
    ...
    void testUpdateUser_EmptyEmail() {
        ...
        // When
        UserDTO result = userService.updateUser(1L, updateWithEmptyEmail);
    ...
    void testGetAllUsers_SearchTermFilters() {
        ...
        // When
        Page<UserDTO> result = userService.getAllUsers(0, 10, "testuser");
    ...
    void testChangePasswordOnFirstLogin_ClearsRequireAction() {
        ...
        // When
        UserDTO result = userService.changePasswordOnFirstLogin(changeRequest);
    ...
    void testLockUser_AlreadyUnlocked() {
        ...
        // When
        UserDTO result = userService.lockUser(1L, false);
    ...
    void testDisableUser_AlreadyEnabled() {
        ...
        // When
        UserDTO result = userService.disableUser(1L, true);
    ...
    void testGetAllUsers_CorrectPageSize() {
        ...
        // When
        Page<UserDTO> result = userService.getAllUsers(0, 2, "");
    ...
    void testGetAllUsers_LargePageNumber() {
        ...
        // When
        Page<UserDTO> result = userService.getAllUsers(100, 10, "");
