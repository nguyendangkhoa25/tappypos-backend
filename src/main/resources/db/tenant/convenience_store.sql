...
SELECT
    ...
    'ACTIVE'
FROM (VALUES
    ('BEVERAGE', 'VND-001', 'BEV-001', 'Coca-Cola 330ml',              'Nước ngọt có ga lon 330ml',               12000,  8500, 'can'),
    ('BEVERAGE', 'VND-001', 'BEV-002', 'Pepsi 330ml',                  'Nước ngọt có ga lon 330ml',               12000,  8500, 'can'),
    ('BEVERAGE', 'VND-001', 'BEV-003', '7-Up 330ml',                   'Nước ngọt có ga lon 330ml',               11000,  7500, 'can'),
    ('BEVERAGE', 'VND-001', 'BEV-004', 'Red Bull 250ml',               'Nước tăng lực lon 250ml',                 13000,  9500, 'can'),
    ('BEVERAGE', 'VND-001', 'BEV-005', 'Number One 330ml',             'Nước tăng lực lon 330ml',                 10000,  7000, 'can'),
    ('BEVERAGE', 'VND-001', 'BEV-006', 'Nước suối Aqua 500ml',         'Nước tinh khiết chai 500ml',               6000,  3500, 'bottle'),
    ('BEVERAGE', 'VND-001', 'BEV-007', 'Nước suối La Vie 500ml',       'Nước khoáng thiên nhiên chai 500ml',       7000,  4500, 'bottle'),
    ('BEVERAGE', 'VND-001', 'BEV-008', 'Bia Tiger 330ml',              'Bia lon 330ml',                           18000, 13000, 'can'),
    ('BEVERAGE', 'VND-001', 'BEV-009', 'Bia Heineken 330ml',           'Bia lon 330ml',                           25000, 18000, 'can'),
    ('BEVERAGE', 'VND-001', 'BEV-010', 'Bia Saigon Đỏ 330ml',         'Bia lon 330ml',                           15000, 11000, 'can'),
    ('BEVERAGE', 'VND-001', 'BEV-011', 'Trà Olong Tea Plus 455ml',     'Trà Olong chai PET 455ml',                12000,  8000, 'bottle'),
    ('BEVERAGE', 'VND-001', 'BEV-012', 'Trà xanh 0 Độ 455ml',         'Trà xanh không đường chai 455ml',         12000,  8000, 'bottle'),
    ('BEVERAGE', 'VND-001', 'BEV-013', 'Sting Dâu 330ml',             'Nước tăng lực hương dâu lon 330ml',       10000,  7000, 'can'),
    ('FOOD',     'VND-001', 'FOOD-001', 'Mì Hảo Hảo Tôm Chua Cay 75g','Mì ăn liền gói 75g',                      7000,  4800, 'pack'),
    ('FOOD',     'VND-001', 'FOOD-002', 'Mì 3 Miền Bò Hầm Rau 65g',   'Mì ăn liền gói 65g',                      6000,  4000, 'pack'),
    ('FOOD',     'VND-001', 'FOOD-003', 'Phở Bò Ăn Liền Vifon 65g',   'Phở ăn liền gói 65g',                     8000,  5500, 'pack'),
    ('FOOD',     'VND-001', 'FOOD-004', 'Cháo Thịt Bằm Vifon 50g',    'Cháo ăn liền gói 50g',                   12000,  8500, 'pack'),
    ('FOOD',     'VND-002', 'FOOD-005', 'Sữa TH True Milk 180ml',      'Sữa tươi tiệt trùng hộp',                 8000,  5800, 'box'),
    ('FOOD',     'VND-002', 'FOOD-006', 'Sữa Vinamilk UHT 180ml',      'Sữa tươi UHT hộp 180ml',                  7500,  5200, 'box'),
    ('FOOD',     'VND-002', 'FOOD-007', 'Nước mắm Nam Ngư 500ml',      'Nước mắm chai thuỷ tinh 500ml',           18000, 12500, 'bottle'),
    ('FOOD',     'VND-002', 'FOOD-008', 'Dầu ăn Neptune 500ml',        'Dầu thực vật chai 500ml',                 42000, 31000, 'bottle'),
    ('FOOD',     'VND-002', 'FOOD-009', 'Mì chính Ajinomoto 100g',     'Bột ngọt gói 100g',                       12000,  8500, 'pack'),
    ('CONVENIENCE','VND-002','CONV-001','Bánh Oreo 97g',               'Bánh quy kem 97g',                        18000, 13000, 'pack'),
    ('CONVENIENCE','VND-002','CONV-002','Snack Poca Khoai Tây BBQ 68g','Snack khoai tây vị BBQ gói 68g',          12000,  8500, 'pack'),
    ('CONVENIENCE','VND-002','CONV-003','Kẹo Dừa Bến Tre 200g',        'Kẹo dừa truyền thống gói 200g',           25000, 18000, 'pack'),
    ('CONVENIENCE','VND-002','CONV-004','Bánh Kinh Đô Hương Vani',     'Bánh quy bơ hộp 150g',                    22000, 15000, 'box'),
    ('BEAUTY',   'VND-001', 'BEAU-001', 'Kem đánh răng Colgate 150g',  'Kem đánh răng bảo vệ toàn diện',          35000, 25000, 'tube'),
    ('BEAUTY',   'VND-001', 'BEAU-002', 'Dầu gội Clear Mát Lạnh 170ml','Dầu gội sạch gàu chai 170ml',             45000, 33000, 'bottle'),
    ('BEAUTY',   'VND-001', 'BEAU-003', 'Xà phòng Lifebuoy 90g',       'Xà phòng kháng khuẩn 90g',                18000, 13000, 'bar'),
    ('BEAUTY',   'VND-001', 'BEAU-004', 'Bàn chải Oral-B Classic',     'Bàn chải đánh răng lông mềm',             25000, 18000, 'piece'),
    ('CONVENIENCE','VND-002','CONV-005','Nước rửa chén Sunlight 500ml','Nước rửa chén chai 500ml',                22000, 16000, 'bottle'),
    ('CONVENIENCE','VND-002','CONV-006','Bột giặt Omo Comfort 400g',   'Bột giặt thơm gói 400g',                  32000, 24000, 'pack'),
    ('CONVENIENCE','VND-002','CONV-007','Túi nilon HDPE 30 cái',       'Túi đựng hàng 30x40cm, 30 cái/cuộn',      5000,  3000, 'roll'),
    ('CONVENIENCE','VND-002','CONV-008','Thuốc lá Esse Menthol',       'Thuốc lá Esse bạc hà 1 bao',              30000, 25000, 'bag'),
    ('CONVENIENCE','VND-002','CONV-009','Thuốc lá 555 State Express',  'Thuốc lá 555 1 bao',                      35000, 30000, 'bag')
