...
import com.knp.model.entity.BankAccount;
import com.knp.repository.BankAccountRepository;
...
public class BankAccountServiceImpl implements BankAccountService {
    ...
    private BankAccount findActive(Long id) {
        BankAccount account = repo.findById(id)
                .orElseThrow(() -> new EntityNotFoundException("Bank account not found: " + id));
        if (account.isDeleted()) throw new EntityNotFoundException("Bank account not found: " + id);
        return account;
    }
