package com.knp.service.buyback;
...
import com.knp.model.entity.buyback.BuybackOrder.OrderStatus;
import com.knp.model.entity.buyback.BuybackOrder.OrderType;
import com.knp.model.entity.buyback.BuybackOrderItem;
import com.knp.model.entity.buyback.BuybackOrderItem.ItemType;
import com.knp.model.entity.buyback.BuybackOrderItem.ItemCondition;
...
public class BuybackOrderService {
    ...
    public BuybackOrderDTO complete(Long id) {
        ...
        if (order.getStatus() != OrderStatus.PENDING) {
            throw new BadRequestException(messageService.getMessage("error.buyback.onlyPendingCanComplete", new Object[]{order.getStatus()}));
        }
    ...
    public BuybackOrderDTO cancel(Long id) {
        ...
        if (order.getStatus() == OrderStatus.CANCELLED) {
            throw new BadRequestException(messageService.getMessage("error.buyback.alreadyCancelled"));
        }
