...
import com.knp.model.entity.LoyaltyProgram;
import com.knp.model.entity.LoyaltyTier;
import com.knp.model.entity.LoyaltyTransaction;
import com.knp.model.enums.LoyaltyTransactionType;
import com.knp.repository.CustomerRepository;
import com.knp.repository.LoyaltyProgramRepository;
import com.knp.repository.LoyaltyTierRepository;
import com.knp.repository.LoyaltyTransactionRepository;
...
public class LoyaltyService {
    ...
    public BigDecimal redeemPoints(Long customerId, int pointsToRedeem, Long orderId) {
        ...
        if (pointsToRedeem < program.getMinRedemptionPoints()) {
            throw new BadRequestException("Minimum " + program.getMinRedemptionPoints() + " points required to redeem");
        }
        if (balance < pointsToRedeem) {
            throw new BadRequestException("Insufficient points: available " + balance + ", requested " + pointsToRedeem);
        }
