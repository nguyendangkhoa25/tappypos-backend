...
import com.knp.service.InventoryService;
...
public class InventoryController {
     ...
     */
    @PostMapping
    @PreAuthorize("hasAnyRole('SHOP_OWNER', 'MANAGER', 'INVENTORY_MANAGER')")
     ...
     */
    @GetMapping("/{id}")
    @PreAuthorize("hasAnyRole('SHOP_OWNER', 'MANAGER', 'INVENTORY_MANAGER', 'STAFF')")
