...
public interface LoyaltyTransactionRepository extends JpaRepository<LoyaltyTransaction, Long> {
    ...
    @Query("SELECT t FROM LoyaltyTransaction t WHERE t.customerId = :customerId AND t.type = com.tappy.pos.model.enums.LoyaltyTransactionType.REDEEMED AND t.orderId IS NULL AND t.deleted = false ORDER BY t.createdAt DESC LIMIT 1")
